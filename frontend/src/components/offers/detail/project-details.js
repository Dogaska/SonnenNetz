...
export function ProjectOfferDetails() {
    ...
    const GetOfferData = () => {
        AxiosInstance.get(`api/offers/${slug}`)
            .then((res) => {
            if (res.data) {
                setOfferData(res.data.project_offer);
                console.log(res.data.project_offer);
            }
        })
            .catch((error) => {
